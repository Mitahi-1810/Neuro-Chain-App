...
const TaskReviewScreen: React.FC<Props> = ({ navigation, route }) => {
  const { taskIndex, videoUri } = route.params as {
    taskIndex: number;
    videoUri: string;
  };
  ...
  const [analysisState, setAnalysisState] =
    useState<AnalysisState>("uploading");
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.sub}>
            Review your clip, then confirm or retake.
          </Text>
        </View>
        ...
        {videoUri ? (
          ...
          <View style={styles.noVideoBox}>
            ...
            <Text style={styles.noVideoText}>
              No video captured. Please retake.
            </Text>
          </View>
        )}
          ...
          <CrayonCard variant="sun" padding={18} style={styles.previewCard}>
            ...
            <View style={styles.previewGrid}>
              ...
              <MetricChip
                ...
                value={
                  result.social_smiling.observed
                    ? result.social_smiling.type
                    : "none"
                }
                color={task.accentColor}
              />
            ...
            {result.video_quality === "poor" && (
              <View style={styles.qualityWarn}>
                ...
                <Text style={styles.qualityWarnText}>
                  Video was hard to read — consider retaking for a clearer
                  result.
                </Text>
              </View>
            )}
